      ...
      <div className="w-full md:w-1/3 flex items-center justify-center bg-white min-h-screen">
        <div className="w-full max-w-md px-4 sm:px-6 md:px-8 py-8 md:py-12">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-gray-800 text-2xl sm:text-3xl font-bold mb-2">Bem-vindo de volta</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between mt-6">
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-[#9747FF] hover:text-purple-600 transition-colors">
                  Esqueceu sua senha?
                </a>
              </div>
            </div>
