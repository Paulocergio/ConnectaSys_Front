  ...
  if (isMobile) {
    return (
      <div className="relative">
        ...
        >
          <div className={`w-4 h-4 flex flex-col justify-center items-center transform transition-all duration-300 ${mobileMenuOpen ? 'rotate-45' : ''}`}>
            <span className={`block w-3.5 h-0.5 bg-gray-600 transform transition-all duration-300 ${mobileMenuOpen ? 'rotate-90 translate-y-0' : '-translate-y-1'}`}></span>
            <span className={`block w-3.5 h-0.5 bg-gray-600 transform transition-all duration-300 ${mobileMenuOpen ? 'opacity-0' : 'opacity-100'}`}></span>
            <span className={`block w-3.5 h-0.5 bg-gray-600 transform transition-all duration-300 ${mobileMenuOpen ? '-rotate-90 -translate-y-0' : 'translate-y-1'}`}></span>
          </div>
        </button>

        {/* Menu dropdown mobile ocupando toda a tela */}
        <div className={`fixed inset-0 bg-white z-40 transform transition-all duration-300 ease-out md:hidden ${
          mobileMenuOpen 
          ...
          <nav className="flex-1 px-6 py-8 overflow-y-auto bg-white" onClick={(e) => e.stopPropagation()}>
