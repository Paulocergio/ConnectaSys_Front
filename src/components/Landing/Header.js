...
export default function Header() {
  ...
  return (
    <section
      id="sobre"
      className="relative min-h-screen flex items-center bg-[#101218] text-white py-16"
    >
      {" "}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold mb-8 leading-tight">
              <span className="text-white">Gestão moderna</span>
              <br />
            ...
            <p className="text-xl text-gray-300 mb-10 leading-relaxed">
              Transforme sua oficina com uma plataforma completa e intuitiva. Controle todos os
              aspectos do seu negócio em um único sistema.
            </p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-[#0C1228] to-[#161E42] rounded-2xl overflow-hidden shadow-2xl border border-indigo-500/20">
                ...
                <div className="flex justify-between items-center p-4 border-b border-indigo-500/10">
                  ...
                  <div className="text-sm text-indigo-300 font-semibold tracking-wider">
                    ConnectaSys
                  </div>
