  ...
  const features = [
    {
      ...
      description:
        "Mantenha todos os dados dos seus clientes organizados em um só lugar com histórico completo de serviços e lembretes automáticos.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "Acompanhe todas as ordens de serviço desde a abertura até a conclusão com status em tempo real e notificações personalizadas.",
      icon: (
        <svg
          className="w-7 h-7 text-white"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Monitore receitas, despesas e lucros com relatórios detalhados, dashboards interativos e previsões baseadas em IA.",
      icon: (
        <svg
          className="w-7 h-7 text-white"
          fill="none"
