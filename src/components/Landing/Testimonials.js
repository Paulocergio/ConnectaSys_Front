  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Testimonials Carousel - Border removed */}
        <div className="relative">
          {/* Inner Container with Gradient Border Effect */}
          <div className="bg-[#101218] text-white rounded-xl overflow-hidden relative">
            <div className="absolute inset-0 bg-[#101218] z-0"></div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                      ...
                      <div className="md:col-span-4 flex flex-col items-center md:items-start">
                        <div className="relative mb-4 group">
                          {/* Avatar with Decorative Ring and Glow Effect */}
                          ...
                          <div className="absolute -bottom-1 -right-1 bg-indigo-500 text-white rounded-full w-8 h-8 md:w-10 md:h-10 flex items-center justify-center border-2 border-[#050B16] shadow-md">
          ...
          {/* Navigation Arrows - Repositioned to the sides of the content */}
          <button
            className="absolute top-1/2 -left-6 transform -translate-y-1/2 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg focus:outline-none hover:shadow-indigo-500/25 z-10 transition-all hover:scale-110"
            onClick={prevSlide}
          ...
          <button
            className="absolute top-1/2 -right-6 transform -translate-y-1/2 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg focus:outline-none hover:shadow-indigo-500/25 z-10 transition-all hover:scale-110"
            onClick={nextSlide}
